...
from octopus_fs.core.base import BaseArm
...
def resolve(spec: str | list[str]) -> list[str]:
    ...
    TODO(you): presets live in octopus_fs.config.ARM_PRESETS. Validate every name
    here so a typo fails before any data is touched.
    """
    raise NotImplementedError


# TODO(you): importing octopus_fs.arms must be what populates _REGISTRY.
# Do it in octopus_fs/arms/__init__.py, not here, to avoid a circular import.
